/*
                ...
                Braiding is free software; you can redistribute Ait and/or
   modify Ait under the terms of the GNU General Public License as published by
   ...
   License along with Braiding; if not, write to the Free Software Foundation,
...
int main() {
    ...
    char c, *file;
    sint16 p = 0, power = 1, power2 = 1, i, j, n, repeat = 0, size, type,
           rigidity, iteration;
    list<sint16> word, word2, graph, graphinv;
    list<sint16>::iterator itw, itg;

    ArtinBraid AB = ArtinBraid(1), AB1 = ArtinBraid(1), AB2 = ArtinBraid(1),
               AB3 = ArtinBraid(1), AC = ArtinBraid(1);
    list<ArtinBraid> Asss, Atraj, ACent, Avertices, Abarrows;
    list<ArtinBraid>::iterator Ait, Aitb;
    ...
    while (1) {
        ...
        while (1) {
            ...
            cout << endl
                 ...
                 << endl
                 << endl
                 << "Choose an option: (type '?' for help) ";
            cin >> ws >> c;
            ...
            if (c == 'l' || c == 'r') {
                ...
                if (c == 'l') {
                    ...
                    f.open(file);
                    f << endl
                      << "The Left Normal Form of the braid on " << n
                      << " strands" << endl
                      << endl;
                    f.close();
                ...
                if (c == 'r') {
                    ...
                    f.open(file);
                    f << endl
                      << "The Right Normal Form of the braid on " << n
                      << " strands" << endl
                      << endl;
                    f.close();
                    PrintWord(word, n, power, file);
            ...
            if (c == 'p') {
                ...
                cout << endl
                     << "The permutation associated to this braid is:" << endl
                     << endl;

                f << "The permutation associated to the braid on " << n
                  << " strands" << endl
                  << endl;
                f.close();
                PrintWord(word, n, power, file);
            ...
            if (c == 'x') {
                ...
                cout << "The crossing numbers of this braid are:" << endl
                     << endl
                     << "    ";
                f << "The crossing numbers of the braid on " << n << " strands"
                  << endl
                  << endl;
                f.close();
                PrintWord(word, n, power, file);
            ...
            if (c == '^' || c == 'v') {
                ...
                if (c == 'v')
                    f << "The lcm of the braids on " << n << " strands" << endl
                      << endl;
                else
                    f << "The gcd of the braids on " << n << " strands" << endl
                      << endl;
                f.close();
                PrintWord(word, n, power, file);
                f.open(file, ios::app);
            ...
            if (c == 'e') {
                ...
                if (conj) {
                    cout << endl
                         << "These braids are conjugate." << endl
                         << endl
                ...
                if (conj) {
                    f << "are conjugate." << endl
                      << endl
                      << "A conjugating braid is" << endl
                      << endl;
                    f.close();
            ...
            if (c == 'z') {
                ...
                cout << endl
                     << "The centralizer of this braid is generated by: "
                     << endl;
            ...
            if (c == 'a') {
                if (p) {
                    ...
                    power = 1;
                    cout << endl
                         << "The option of taking powers is disabled." << endl
                         << endl;
                } else {
                    p = 1;
                    cout << endl
                         << "The option of taking powers is enabled." << endl
                         << endl;
                }
            }
