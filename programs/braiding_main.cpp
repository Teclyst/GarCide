		...
		while (1)
		{
			...
			if (c == 'l' || c == 'r')
			{
				...
				if (c == 'l')
				{
					...
					f.open(file);
					f << endl
						<< "The Left Normal Form of the braid on "
						<< n << " strands" << endl
						<< endl;
					f.close();
				...
				if (c == 'r')
				{
					...
					f.open(file);
					f << endl
						<< "The Right Normal Form of the braid on "
						<< n << " strands" << endl
						<< endl;
					f.close();
					PrintWord(word, n, power, file);
			...
			if (c == 'p')
			{
				...
				cout << endl
						 << "The permutation associated to this braid is:"
						 << endl
						 << endl;
			...
			if (c == '^' || c == 'v')
			{
				...
				if (c == 'v')
					cout << "The lcm of these braids is:" << endl
							 << endl;
				else
					cout << "The gcd of these braids is:" << endl
							 << endl;
				PrintBraidWord(AB);
				cout << endl
						 << endl;
			...
			if (c == 'e')
			{
				...
				{
					cout << endl
							 << "These braids are not conjugate." << endl;
				}

				f.open(file);

				f << "The braids on " << n << " strands" << endl
					<< endl;
				f.close();
				PrintWord(word, n, power, file);
				f.open(file, ios::app);
			...
			if (c == 'z')
			{
				...
				f << endl
					<< endl
					<< "is generated by the following braids:";
				f.close();
			...
			if (c == 'a')
			{
				if (p)
				{
					...
					power = 1;
					cout << endl
							 << "The option of taking powers is disabled."
							 << endl
							 << endl;
				}
				else
				{
					p = 1;
					cout << endl
							 << "The option of taking powers is enabled."
							 << endl
							 << endl;
				}
			}
